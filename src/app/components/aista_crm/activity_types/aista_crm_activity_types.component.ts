...
import { EditAista_crm_activity_typesComponent } from './modals/edit.aista_crm_activity_types.component';
 ...
 */
@Component({
  selector: 'app-aista_crm_activity_types',
  templateUrl: './aista_crm_activity_types.component.html',
  styleUrls: ['./aista_crm_activity_types.component.scss'],
  animations: [
...
export class Aista_crm_activity_typesComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.aista_crm_activity_types.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.aista_crm_activity_types.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.aista_crm_activity_types.delete(ids);
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditAista_crm_activity_typesComponent, {
