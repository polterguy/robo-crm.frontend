 ...
 */
@Component({
  templateUrl: './edit.aista_crm_contacts.component.html'
})
export class EditAista_crm_contactsComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditAista_crm_contactsComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.aista_crm_contacts.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.aista_crm_contacts.create(this.data.entity);
  }
