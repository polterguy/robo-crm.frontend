...
import { EditAista_crm_notificationsComponent } from './modals/edit.aista_crm_notifications.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Notifications
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-aista_crm_notifications',
  templateUrl: './aista_crm_notifications.component.html',
  styleUrls: ['./aista_crm_notifications.component.scss'],
  animations: [
...
export class Aista_crm_notificationsComponent extends GridComponent implements OnInit {
  ...
  public notification_id: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/aista-crm/notifications';
  }
  ...
  protected read(filter: any) {
    return this.httpService.aista_crm_notifications.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.aista_crm_notifications.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.aista_crm_notifications.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.message = this.createFormControl('notifications.message.like');
    this.created = this.createFormControl('notifications.created.eq');
    this.notification_id = this.createFormControl('notifications.notification_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditAista_crm_notificationsComponent, {
