...
/**
 * Modal dialog for editing your existing Notifications entity types, and/or
 * creating new entity types of type Notifications.
 */
@Component({
  templateUrl: './edit.aista_crm_notifications.component.html'
})
export class EditAista_crm_notificationsComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditAista_crm_notificationsComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['notification_id'];
    this.createColumns = [
      'message'
    ];
    this.updateColumns = [
  ...
  protected getUpdateMethod() {
    return this.service.aista_crm_notifications.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.aista_crm_notifications.create(this.data.entity);
  }
