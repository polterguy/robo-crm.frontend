...
/**
 * Modal dialog for editing your existing Tasks entity types, and/or
 * creating new entity types of type Tasks.
 */
@Component({
  templateUrl: './edit.aista_crm_tasks.component.html'
})
export class EditAista_crm_tasksComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditAista_crm_tasksComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.aista_crm_tasks.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.aista_crm_tasks.create(this.data.entity);
  }
