...
import { EditAista_crm_blaster_email_templatesComponent } from './modals/edit.aista_crm_blaster_email_templates.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Email_templates
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-aista_crm_blaster_email_templates',
  templateUrl: './aista_crm_blaster_email_templates.component.html',
  styleUrls: ['./aista_crm_blaster_email_templates.component.scss'],
  animations: [
...
export class Aista_crm_blaster_email_templatesComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/aista-crm/blaster/email_templates';
  }
  ...
  protected read(filter: any) {
    return this.httpService.aista_crm_blaster_email_templates.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.aista_crm_blaster_email_templates.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.aista_crm_blaster_email_templates.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.name = this.createFormControl('email_templates.content.like');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditAista_crm_blaster_email_templatesComponent, {
