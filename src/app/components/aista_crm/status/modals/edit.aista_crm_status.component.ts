 ...
 */
@Component({
  templateUrl: './edit.aista_crm_status.component.html'
})
export class EditAista_crm_statusComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditAista_crm_statusComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.aista_crm_status.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.aista_crm_status.create(this.data.entity);
  }
