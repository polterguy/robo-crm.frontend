...
import { EditAista_crm_statusComponent } from './modals/edit.aista_crm_status.component';
 ...
 */
@Component({
  selector: 'app-aista_crm_status',
  templateUrl: './aista_crm_status.component.html',
  styleUrls: ['./aista_crm_status.component.scss'],
  animations: [
...
export class Aista_crm_statusComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.aista_crm_status.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.aista_crm_status.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.aista_crm_status.delete(ids);
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditAista_crm_statusComponent, {
