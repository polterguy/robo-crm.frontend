...
import { EditAista_crm_kpiComponent } from './modals/edit.aista_crm_kpi.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Kpi
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-aista_crm_kpi',
  templateUrl: './aista_crm_kpi.component.html',
  styleUrls: ['./aista_crm_kpi.component.scss'],
  animations: [
...
export class Aista_crm_kpiComponent extends GridComponent implements OnInit {
  ...
  public hyperlambda: FormControl;
  public kpi_id: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/aista-crm/kpi';
  }
  ...
  protected read(filter: any) {
    return this.httpService.aista_crm_kpi.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.aista_crm_kpi.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.aista_crm_kpi.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.name = this.createFormControl('kpi.name.like');
    this.type = this.createFormControl('kpi.type.like');
    this.hyperlambda = this.createFormControl('kpi.hyperlambda.like');
    this.kpi_id = this.createFormControl('kpi.kpi_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditAista_crm_kpiComponent, {
