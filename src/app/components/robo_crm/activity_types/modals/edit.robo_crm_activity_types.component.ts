 ...
 */
@Component({
  templateUrl: './edit.robo_crm_activity_types.component.html'
})
export class EditRobo_crm_activity_typesComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditRobo_crm_activity_typesComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.robo_crm_activity_types.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.robo_crm_activity_types.create(this.data.entity);
  }
