...
import { EditRobo_crm_activity_typesComponent } from './modals/edit.robo_crm_activity_types.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Activity_types
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-robo_crm_activity_types',
  templateUrl: './robo_crm_activity_types.component.html',
  styleUrls: ['./robo_crm_activity_types.component.scss'],
  animations: [
...
export class Robo_crm_activity_typesComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/robo-crm/activities/activity_types';
  }
  ...
  protected read(filter: any) {
    return this.httpService.robo_crm_activity_types.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.robo_crm_activity_types.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.robo_crm_activity_types.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.type = this.createFormControl('activity_types.type.like');
    this.description = this.createFormControl('activity_types.description.like');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditRobo_crm_activity_typesComponent, {
