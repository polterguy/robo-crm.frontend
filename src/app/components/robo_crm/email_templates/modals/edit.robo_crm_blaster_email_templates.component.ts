 ...
 */
@Component({
  templateUrl: './edit.robo_crm_blaster_email_templates.component.html'
})
export class EditRobo_crm_blaster_email_templatesComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditRobo_crm_blaster_email_templatesComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.robo_crm_blaster_email_templates.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.robo_crm_blaster_email_templates.create(this.data.entity);
  }
