...
import { EditRobo_crm_blaster_email_templatesComponent } from './modals/edit.robo_crm_blaster_email_templates.component';
 ...
 */
@Component({
  selector: 'app-robo_crm_blaster_email_templates',
  templateUrl: './robo_crm_blaster_email_templates.component.html',
  styleUrls: ['./robo_crm_blaster_email_templates.component.scss'],
  animations: [
...
export class Robo_crm_blaster_email_templatesComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/robo-crm/blaster/email_templates';
  }
  ...
  protected read(filter: any) {
    return this.httpService.robo_crm_blaster_email_templates.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.robo_crm_blaster_email_templates.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.robo_crm_blaster_email_templates.delete(ids);
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditRobo_crm_blaster_email_templatesComponent, {
