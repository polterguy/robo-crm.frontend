...
import { EditRobo_crm_statusComponent } from './modals/edit.robo_crm_status.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Status
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-robo_crm_status',
  templateUrl: './robo_crm_status.component.html',
  styleUrls: ['./robo_crm_status.component.scss'],
  animations: [
...
export class Robo_crm_statusComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/robo-crm/accounts/status';
  }
  ...
  protected read(filter: any) {
    return this.httpService.robo_crm_status.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.robo_crm_status.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.robo_crm_status.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.status = this.createFormControl('status.status.like');
    this.description = this.createFormControl('status.description.like');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditRobo_crm_statusComponent, {
