...
import { EditRobo_crm_activitiesComponent } from './modals/edit.robo_crm_activities.component';
 ...
 */
@Component({
  selector: 'app-robo_crm_activities',
  templateUrl: './robo_crm_activities.component.html',
  styleUrls: ['./robo_crm_activities.component.scss'],
  animations: [
...
export class Robo_crm_activitiesComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/robo-crm/activities/activities';
  }
  ...
  protected read(filter: any) {
    return this.httpService.robo_crm_activities.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.robo_crm_activities.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.robo_crm_activities.delete(ids);
  }
