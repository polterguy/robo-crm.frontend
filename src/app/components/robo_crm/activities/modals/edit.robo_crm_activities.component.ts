 ...
 */
@Component({
  templateUrl: './edit.robo_crm_activities.component.html',
  styleUrls: ['./edit.robo_crm_activities.component.scss']
})
export class EditRobo_crm_activitiesComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditRobo_crm_activitiesComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.robo_crm_activities.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.robo_crm_activities.create(this.data.entity);
  }
